	...
	*/
	if( $( '.google-map' )[0] ){
		...
		function googleMapsInit() {
			var mapOptions = {
				zoom: 13,
				center: new google.maps.LatLng(-12.055204422521136, -77.09430911796836),
			...
			marker = new google.maps.Marker( {
				position: new google.maps.LatLng( -12.055204422521136, -77.09430911796836 ),
				map: map,
